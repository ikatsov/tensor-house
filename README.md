...
* Supply Chain
   ...
   * Linear Transportation and Inventory Allocation ([notebook](https://github.com/ikatsov/tensor-house/blob/master/supply-chain/linear-transportation-problem.ipynb))
